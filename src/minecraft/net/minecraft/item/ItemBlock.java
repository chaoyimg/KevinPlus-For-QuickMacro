        ...
        else if (worldIn.canBlockBePlaced(this.block, pos, false, side, (Entity)null, stack))
        {
            ...
            if (worldIn.setBlockState(pos, iblockstate1, 3))
            {
                ...
                if (highVerFix.getState()) {
                    Minecraft.getMinecraft().theWorld.playSoundAtPos(pos, this.block.stepSound.getPlaceSound(), (this.block.stepSound.getVolume() + 1.0f) / 2.0f, this.block.stepSound.getFrequency() * 0.8f, false);
                }else {
