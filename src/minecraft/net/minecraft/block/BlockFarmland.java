...
public class BlockFarmland extends Block
{
    ...
    public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        double maxY1 = highVerFix.getState() ? 0.9375 : 1;
        return new AxisAlignedBB((double)pos.getX(), (double)pos.getY(), (double)pos.getZ(), (double)(pos.getX() + 1), (double)(pos.getY() + maxY1), (double)(pos.getZ() + 1));
    }
