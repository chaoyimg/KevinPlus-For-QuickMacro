...
class NoSlow : Module("NoItemSlow", "Cancels slowness effects caused by soulsand and using items.", category = ModuleCategory.MOVEMENT) {
    ...
    fun onMotion(event: MotionEvent) {
        ...
        if (packetMode equal "SpecialGrim") {
            if (isUsing || isBlocking|| aura.blockingStatus) {
                ...
                if (event.eventState == EventState.POST) {
                    if (mc.thePlayer.heldItem.item is ItemBow || mc.thePlayer.heldItem.item is ItemSword) {
